...
**Haidilao International Holding Ltd.** совместно с **Panasonic** создали ресторан, который управляется искусственным интеллектом, а часть персонала в нем заменена роботами.
...
Клиенты в свою очередь могут сделать заказ на планшете, сформировать на нем счет и оплатить его.
